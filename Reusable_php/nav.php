...
<body>
    <nav class="navbar navbar-expand-lg" style="background-color: #d5d2d1ff">

        <div class="container-fluid">

            <a class="navbar-brand text-white" href="#"><img src="../Picture/Logo3.png" style="width:100px; height:100px" class="img-responsive"></a></a>
